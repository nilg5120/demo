...
function populateSection(sectionData, sectionId) {
    ...
    if (sectionData.name || sectionData.birthday || sectionData.address || sectionData.phone) {
        ...
        dl1.append(`<div class="box1-1"><dt>氏名</dt><dd>${sectionData.name}</dd></div>`);
        ...
        dl21.append(`<div class="box2-1"><dt>住所</dt><dd>${sectionData.address}</dd></div>`);
        dl22.append(`<div class="box2-2"><dt>電話番号</dt><dd>${sectionData.phone}</dd></div>`);
        dl22.append(`<div class="box2-2"><dt>メールアドレス</dt><dd>${sectionData.email}</dd></div>`);
        box2.append(dl21);
        box2.append(dl22);
        $section.append(box2);
